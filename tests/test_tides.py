...
def tide(request):
        ...
        # should still pass
        td = uptide.Tides(['Q1', 'P1', 'K2', 'Mm', 'S2',
                           'MS4', 'MN4', 'K1', 'Mf',
                           'L2', 'M2', 'N2', 'Z0', 'Sa',
                           'O1', 'S1', 'Ssa', '2N2', 'MU2',
                           'NU2', 'T2', 'J1', 'EPS2', 'LAMBDA2',
                           'MSQM', 'MFM', 'MTM', 'MSF', 'MSM', 'Mt',
                           'MKS2', 'R2', 'S4', 'N4', 'M1',
                           'ETA2',
                           ])
...
def test_compute_nodal_corrections(tide):
        ...
        for x, y in zip(tide.u,
                        [0.17237799, 0., -0.28250837, 0., 0.,
                         -0.03351794, -0.06703588, -0.14205223, -0.37827392,
                         -0.03351794, -0.03351794, -0.03351794, 0., 0.,
                         0.17237799, 0., 0., -0.03351794, -0.03351794,
                         -0.03351794, 0., -0.20653437, -0.03351794, -0.03351794,
                         -0.37827392, -0.37827392, -0.37827392, -0.03351794, -0.033517938256134971, -0.37827391641037489,
                         -0.31602631, 0., 0., -0.06703588, -0.016758969128067486,
                         -0.27898728559754027]):
            assert_almost_equal(x, y)
        # test amplitude corrections
        print(tide.f)
        for x, y in zip(tide.f,
                        [1.08466026, 1., 1.13971568, 0.94740196, 1.,
                         0.98502979, 0.97005958, 1.05252903, 1.21050452,
                         0.98502979, 0.98502979, 0.98502979, 1., 1.,
                         1.08466026, 1., 1., 0.98502979, 0.98502979,
                         0.98502979, 1., 1.06437745, 0.98502979, 0.98502979,
                         1.21050452, 1.21050452, 1.21050452, 0.98502979, 0.93243175067544382, 1.2105045222776423,
                         1.12474547, 1., 1., 0.97005958, 0.99251489453590247,
                         1.2547553896883401]):
            assert_almost_equal(x, y)
